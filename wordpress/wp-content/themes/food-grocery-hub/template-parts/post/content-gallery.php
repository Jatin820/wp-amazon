 ...
 */
?>
<?php $food_grocery_hub_column_layout = get_theme_mod( 'food_grocery_hub_sidebar_post_layout');
if($food_grocery_hub_column_layout == 'four-column' || $food_grocery_hub_column_layout == 'three-column' ){ ?>
      ...
      <div class="page-box">
        <?php if (!is_single() && function_exists('get_post_gallery')) {
          ...
          if ($gallery && isset($gallery['ids'])) { 
            ...
            <div class="container entry-gallery">
              <div class="row">
                <?php $food_grocery_hub_max_images = min(count($gallery_ids), 4);
                for ($index = 0; $index < $food_grocery_hub_max_images; $index++) {
                  $id = $gallery_ids[$index];
                  $food_grocery_hub_image_url = wp_get_attachment_image_url($id, 'full'); ?>
                  <div class="col-md-6 mb-1 align-self-center">
                    <img class="img-fluid" src="<?php echo esc_url($food_grocery_hub_image_url); ?>" alt="Gallery Image <?php echo ($index + 1); ?>">
                  </div>
                <?php } ?>
              </div>
            </div>
        ...
        <div class="box-content mt-2 text-center">
          ...
          <div class="box-info">
            ...
            $food_grocery_hub_blog_archive_ordering = get_theme_mod('blog_meta_order', array('date', 'author', 'comment', 'category', 'time'));
            ...
            foreach ($food_grocery_hub_blog_archive_ordering as $food_grocery_hub_blog_data_order) : 
                ...
                <?php elseif ('category' === $food_grocery_hub_blog_data_order) : ?>
                    ...
                    ?>
                <?php elseif ('time' === $food_grocery_hub_blog_data_order) : ?>
          ...
          <p><?php echo esc_html( wp_trim_words( get_the_content(), get_theme_mod( 'food_grocery_hub_excerpt_count', 35 ) ) ); ?></p>
...
<div id="category-post">
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="page-box row">
      <?php $food_grocery_hub_post_layout = get_theme_mod( 'food_grocery_hub_post_layout','image-content');
      if($food_grocery_hub_post_layout == 'image-content'){ ?>
      ...
      <?php }
      else if($food_grocery_hub_post_layout == 'content-image'){ ?>
        <div class="box-content col-lg-6 col-md-12">
          <h4><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php the_title_attribute(); ?>"><?php the_title();?></a></h4>
          <div class="box-info">
            <?php 
