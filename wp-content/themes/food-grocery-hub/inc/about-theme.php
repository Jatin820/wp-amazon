	...
	<div class="wrap about-wrap full-width-layout">
		...
		<div class="about-theme">
			<div class="theme-description">
				...
				?></p>
				<p class="actions">
					<a target="_blank" href="<?php echo esc_url( FOOD_GROCERY_HUB_FREE_THEME_URL ); ?>" class="theme-info-btn" target="_blank"><?php esc_html_e( 'Theme Info', 'food-grocery-hub' ); ?></a>

					<a target="_blank" href="<?php echo esc_url( FOOD_GROCERY_HUB_DEMO_THEME_URL ); ?>" class="view-demo" target="_blank"><?php esc_html_e( 'View Demo', 'food-grocery-hub' ); ?></a>

					<a target="_blank" href="<?php echo esc_url( FOOD_GROCERY_HUB_DOCS_THEME_URL ); ?>" class="instruction-theme" target="_blank"><?php esc_html_e( 'Theme Instructions', 'food-grocery-hub' ); ?></a>

					<a target="_blank" href="<?php echo esc_url( FOOD_GROCERY_HUB_RATE_THEME_URL ); ?>" class="rate-theme" target="_blank"><?php esc_html_e( 'Rate this theme', 'food-grocery-hub' ); ?></a>

					<a target="_blank" href="<?php echo esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ); ?>" class="pro-btn-theme" target="_blank"><?php esc_html_e( 'Upgrade to pro', 'food-grocery-hub' ); ?></a>
				</p>
			</div>
        ...
        if ( isset( $_GET['import-demo'] ) && $_GET['import-demo'] == true ) { ?>
            <div class="col card success-demo" style="text-align: center;">
                ...
                <a class="button" href="<?php echo esc_url(home_url('/')); ?>" target="_blank">
                    <?php echo esc_html__('View Site', 'food-grocery-hub'); ?>
                </a>
            </div>
            ...
            <div id="demo-success-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999;">
                <div style="background: #fff; padding: 30px; max-width: 400px; margin: 15% auto; text-align: center; border-radius: 8px;">
                    <h2 style="margin-bottom: 15px;"><?php echo esc_html__('Demo import completed successfully. You can now customize your website or view the imported content.', 'food-grocery-hub'); ?></h2>
            ...
            <div class="col card demo-btn text-center">
                <form id="demo-importer-form" action="<?php echo esc_url(home_url()); ?>/wp-admin/themes.php" method="POST">
                    ...
                    <div id="page-loader" style="display:none; margin-top: 20px; text-align: center;">
                        ...
                        <p style="margin-top:10px;"><?php echo esc_html__('Importing demo, please wait...', 'food-grocery-hub'); ?></p>
                    </div>
                </form>
            </div>
