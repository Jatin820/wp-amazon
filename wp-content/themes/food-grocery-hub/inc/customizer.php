...
function Food_Grocery_Hub_Customize_register( $wp_customize ) {
	...
	// Pro Version
    class food_grocery_hub_Customize_Pro_Version extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            echo '<a href="'. esc_url($this->description) .'" target="_blank">';
                ...
                echo '<strong> '. esc_html( FOOD_GROCERY_HUB_BUY_TEXT,'food-grocery-hub' ) .'<strong></a>';
            echo '</a>';
        }
    }

    // Custom Controls
    function food_grocery_hub_sanitize_custom_control( $input ) {
        return $input;
    }
	...
	$wp_customize->add_setting( 'food_grocery_hub_tp_preloader_color1_option', array(
  	...
  	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_preloader_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_preloader_pro_version_logo', array(
        'section'     => 'food_grocery_hub_prelaoder_option',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
        'priority'    => 100
    )));
	...
	$wp_customize->add_setting( 'food_grocery_hub_menu_color', array(
  	...
  	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_menu_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_menu_pro_version_logo', array(
        'section'     => 'food_grocery_hub_menu_typography',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
	...
	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_header_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_header_pro_version_logo', array(
        'section'     => 'food_grocery_hub_topbar',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
	...
	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_social_media_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_social_media_pro_version_logo', array(
        'section'     => 'food_grocery_hub_social_media',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
	...
	$wp_customize->add_setting( 'food_grocery_hub_show_slider_title', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'food_grocery_hub_sanitize_checkbox',
	) );
	$wp_customize->add_control( new food_grocery_hub_Toggle_Control( $wp_customize, 'food_grocery_hub_show_slider_title', array(
		'label'       => esc_html__( 'Show / Hide Slider Heading', 'food-grocery-hub' ),
		'section'     => 'food_grocery_hub_slider_section',
		'type'        => 'toggle',
		'settings'    => 'food_grocery_hub_show_slider_title',
	) ) );
	...
	//Slider height
    $wp_customize->add_setting('food_grocery_hub_slider_img_height',array(
        'default'=> '',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('food_grocery_hub_slider_img_height',array(
        'label' => __('Slider Height','food-grocery-hub'),
        'description'   => __('Add slider height in px(eg. 700px).','food-grocery-hub'),
        'section'=> 'food_grocery_hub_slider_section',
        'type'=> 'text'
    ));

	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_slider_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_slider_pro_version_logo', array(
        'section'     => 'food_grocery_hub_slider_section',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
	...
	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_about_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_about_pro_version_logo', array(
        'section'     => 'food_grocery_hub_banner_main_sec',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
	...
	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_footer_widget_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_footer_widget_pro_version_logo', array(
        'section'     => 'food_grocery_hub_footer_section',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
	...
	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_copyright_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_copyright_pro_version_logo', array(
        'section'     => 'food_grocery_hub_footer_copyright_section',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
	...
	// Pro Version
    $wp_customize->add_setting( 'food_grocery_hub_responsive_pro_version_logo', array(
        'sanitize_callback' => 'food_grocery_hub_sanitize_custom_control'
    ));
    $wp_customize->add_control( new food_grocery_hub_Customize_Pro_Version ( $wp_customize,'food_grocery_hub_responsive_pro_version_logo', array(
        'section'     => 'food_grocery_hub_mobile_media_option',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Features ', 'food-grocery-hub' ),
        'description' => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL ),
...
if ( ! defined( 'FOOD_GROCERY_HUB_TEXT' ) ) {
    define( 'FOOD_GROCERY_HUB_TEXT', __( 'Food Grocery Hub Pro','food-grocery-hub' ));
}
if ( ! defined( 'FOOD_GROCERY_HUB_BUY_TEXT' ) ) {
    define( 'FOOD_GROCERY_HUB_BUY_TEXT', __( 'Upgrade Pro','food-grocery-hub' ));
}
...
load_template( trailingslashit( get_template_directory() ) . '/inc/section-pro.php' );
    ...
    $manager->register_section_type( Food_Grocery_Hub_Button::class );

    $manager->add_section(
        new Food_Grocery_Hub_Button( $manager, 'food_grocery_hub_pro', [
            'title'       => esc_html( FOOD_GROCERY_HUB_TEXT,'food-grocery-hub' ),
            'priority'    => 0,
            'button_text' => __( 'GET PREMIUM', 'food-grocery-hub' ),
            'button_url'  => esc_url( FOOD_GROCERY_HUB_PRO_THEME_URL )
        ] )
    );
