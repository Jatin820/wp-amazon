...
/*--------------------------- banner image Opacity -------------------*/
    ...
    // Slider Height
    $food_grocery_hub_slider_img_height      = get_theme_mod('food_grocery_hub_slider_img_height');

    // Desktop height
    $food_grocery_hub_tp_theme_css .= '@media screen and (min-width: 768px) {';
    $food_grocery_hub_tp_theme_css .= '#slider {';
    if ( $food_grocery_hub_slider_img_height ) {
        $food_grocery_hub_tp_theme_css .= 'height: ' . esc_attr( $food_grocery_hub_slider_img_height ) . ';';
    }
    $food_grocery_hub_tp_theme_css .= 'width: 100%;';
    $food_grocery_hub_tp_theme_css .= '}';
    $food_grocery_hub_tp_theme_css .= '}';