...
$food_grocery_hub_related = wp_get_post_terms( get_the_ID(), 'category' );
$food_grocery_hub_ids = array();
foreach( $food_grocery_hub_related as $term ) {
    $food_grocery_hub_ids[] = $term->term_id;
}

$food_grocery_hub_post_args['category__in'] = $food_grocery_hub_ids; 

$food_grocery_hub_related_posts = new WP_Query( $food_grocery_hub_post_args );

if ( $food_grocery_hub_related_posts->have_posts() ) : ?>
        ...
        <div class="row">
            <?php while ( $food_grocery_hub_related_posts->have_posts() ) : $food_grocery_hub_related_posts->the_post(); ?>
