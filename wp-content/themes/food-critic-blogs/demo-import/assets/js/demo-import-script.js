...
jQuery(document).ready(function(){
    ...
    jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-menu').attr("checked","checked");

    jQuery('#food-critic-blogs-setup-menu').click(function(){
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-menu').css("display","block");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-contact').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-widget').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-social-icon').css("display","none");
    });

    jQuery('#food-critic-blogs-setup-contact').click(function(){
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-menu').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-contact').css("display","block");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-widget').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-social-icon').css("display","none");
    });

    jQuery('#food-critic-blogs-setup-widget').click(function(){
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-menu').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-contact').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-widget').css("display","block");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-social-icon').css("display","none");
    });

    jQuery('#food-critic-blogs-setup-social').click(function(){
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-menu').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-contact').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-widget').css("display","none");
        jQuery('#food-critic-blogs-demo-setup-guid .food-critic-blogs-setup-social-icon').css("display","block");
    });
});