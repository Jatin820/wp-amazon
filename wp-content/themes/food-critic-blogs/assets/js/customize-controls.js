( function( $ ) {
  var this_obj = food_critic_blogs_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'food_critic_blogs_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'food_critic_blogs_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'food_critic_blogs_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'food_critic_blogs_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.food-critic-blogs-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.food-critic-blogs-customizer-tab').removeClass('active');
